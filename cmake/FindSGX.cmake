# 28-Aug'19 - From https://raw.githubusercontent.com/zhang-xin/SGX-CMake/master/cmake/FindSGX.cmake
...
if (SGX_FOUND)
    ...
    function(add_trusted_library target)
        ...
        target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
            ...
            -Wl,--start-group -lsgx_tstdc -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tprotected_fs -lsgx_tcrypto -l${SGX_TSVC_LIB} -Wl,--end-group \
    ...
    function(add_enclave_library target)
        ...
        target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
            ...
            -Wl,--no-whole-archive \
            -Wl,--start-group ${TLIB_LIST} -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tprotected_fs -lsgx_tcrypto -l${SGX_TSVC_LIB} -lsgx_tsgxssl_crypto -Wl,--end-group \
            -Wl,-Bstatic -Wl,-Bsymbolic -Wl,--no-undefined \
            -Wl,-pie,-eenclave_entry -Wl,--export-dynamic \
            ${LDSCRIPT_FLAG} \
            -Wl,--defsym,__ImageBase=0")
    ...
    function(enclave_sign target)
        ...
        if ("${SGX_OUTPUT}" STREQUAL "")
            ...
            set(OUTPUT_NAME "${target}.signed.so" PARENT_SCOPE)
        else ()
            set(OUTPUT_NAME ${SGX_OUTPUT}) 
            set(OUTPUT_NAME ${SGX_OUTPUT} PARENT_SCOPE) 
        endif ()
